...
- title: Heit. Balestrand Sauna
  desc: Sauna right on the pier with fjord views — seats up to 9. Rent the full sauna or book a drop-in.
  images:
...
- title: Kayak Balestrand
  desc: Guided kayak tours and rentals on the Sognefjord — experience the fjord from the water.
  images:
    - src: /images/balestrandkayak.png
  homepage: https://kayak-balestrand.no/
- title: Balestrand Adventure
  desc: Authentic, nature-based experiences in the heart of the Sognefjord region.
...
- title: Balestrand Fjord Angling
  desc: More than just fishing — stunning fjord views, culture and fresh air along the Sognefjord.
...
- title: The view
  desc: "40 minutes from Balestrand: spectacular fjord views from Gaularfjellet, one of Norway's Scenic Routes."
...
- title: Balestrand lagoon
  desc: Family-friendly swimming lagoon within walking distance — a relaxing spot by the water.
...
- title: Balestrand Cider House
  desc: Locally crafted cider and fruit drinks from Balholm. Tastings, farm shop and restaurant — a short walk from the pier.
...
- title: Hiking
  desc: Trails for all levels — from short viewpoint walks to challenging mountain summits. Map available below.
...
- title: Car Rental in Balestrand
  desc: Explore the region on your own terms. Leigebil.no offers car rental in Balestrand.
  images:
      - src: /images/leigebil.png
        alt: "car rental balestrand"
  button: Visit website
