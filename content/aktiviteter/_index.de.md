...
- title: Heit. Balestrand Sauna
  desc: Sauna direkt am Fjord, auf dem Pier — Platz für 9 Personen. Ganze Sauna mieten oder Drop-in buchen.
  images:
...
- title: Kayak Balestrand
  desc: Geführte Kajak-Touren und Verleih auf dem Sognefjord — den Fjord vom Wasser aus erleben.
  images:
    - src: /images/balestrandkayak.png
  homepage: https://kayak-balestrand.no/
- title: Balestrand Adventure
  desc: Authentische Naturerlebnisse im Herzen der Sognefjord-Region.
...
- title: Balestrand Fjord Angling
  desc: Mehr als nur Angeln — beeindruckende Fjordaussichten, Kultur und frische Luft am Sognefjord.
...
- title: Die Aussicht
  desc: "40 Minuten von Balestrand: spektakuläre Fjordaussicht vom Gaularfjellet, einer der Nationalen Touristenstraßen Norwegens."
...
- title: Balestrand Badelagune
  desc: Familienfreundlicher Badeplatz in Gehweite — ein entspannter Tag direkt am Wasser.
...
- title: Balestrand Cider House
  desc: Lokal produzierter Cider und Fruchtgetränke von Balholm. Verkostung, Hofladen und Restaurant — kurzer Spaziergang vom Pier.
...
- title: Wandern
  desc: Wanderwege für alle Niveaus — von kurzen Aussichtstouren bis zu anspruchsvollen Gipfeln. Karte verfügbar.
  ...
  button: Wanderkarte herunterladen
  source: sognefjord.no

- title: Autovermietung in Balestrand
  desc: Die Region auf eigene Faust erkunden. Leigebil.no bietet Autovermietung in Balestrand.
  images:
      - src: /images/leigebil.png
        alt: "Autovermietung Balestrand"
  button: Zur Website
